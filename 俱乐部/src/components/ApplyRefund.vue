<template>
    <div style="background: #f7f7f7;min-height: 100vh;overflow: hidden;">
        ...
        <div class="active_tap">
            ...
            <div class="act" :class="{'act_selece':act_selece==2}" @click="select(2)">退款中</div>
            <div class="act" :class="{'act_selece':act_selece==3}" @click="select(3)">已退款</div>
        </div>
        <div class="active_box" ref="opBottomEcharts">
            <div class="active">
                <div class="act_main">
                    <div class="act_main_left">
                        <img :src="act_img" alt=""  @click="to_detail(1)">
                        <div class="act_buta" @click="to_refund">申请退款</div>
                    </div>
                    <div class="act_main_right"  @click="to_detail(1)">
