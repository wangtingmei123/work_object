            ...
            <!--<div class="upload_warp torefund_box2">-->
                <!--<div class="upload_warp_img tfright2">-->
                    ...
                    <!--<div class="upload_warp_left tfrboxsc tfrboxsca" id="upload_warp_left" @click="fileClick()" v-if="this.imgList.length < 6">-->
                        <!--&lt;!&ndash;<img src="../assets/upload.png">&ndash;&gt;-->
                        <!--<img  class="jia" :src="jia_img" alt="">-->
                        <!--&lt;!&ndash;<img src="../assets/img/添加图片.png" class="imgs"/>&ndash;&gt;-->
                    <!--</div>-->
                <!--</div>-->
            <!--</div>-->
        </div>
        <div class="creat_club" @click="to_uplode()">回复</div>
    </div>
</template>
        ...
        methods: {
            ...
            to_uplode(){
                ...
                for(let a=0;a<imgList.length;a++){
                    console.log(imgList[a].file.src)
                }
