    ...
    <div class="invited_box_bg" style="background: #fe5857;height:100vh">
       ...
       <div class="invited_box">
           <div class="invited1">
               ...
               <div class="invited1d">俱乐部ID：<span>LK313222</span></div>
           </div>
           <div class="invited2">
    ...
    export default {
        ...
        methods: {
            ...
            sendCode(){
                ...
                var timer = setInterval(function () {
                    console.log(that.sendCodeButtonTxt)
                    timer_number -= 1;

                    if (timer_number <= 0) {
                        that.sendCodeButtonTxt='获取验证码';
                        that.timer_number=0;
                        this.is_sending_code = 0;
                        return clearInterval(timer);
                    }
                    that.sendCodeButtonTxt=timer_number + '秒';
                    that.timer_number= timer_number;
                }, 1000);
