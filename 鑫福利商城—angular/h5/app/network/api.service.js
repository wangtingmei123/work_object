(function(global) {
    ...
    .module('app')
    .constant('ENUM', {
        "PRODUCTS":[1951,1952,1954,1955,1953,1958,1956,2015,1957,2014,2386],
        "PRODUCTS1":[1951,1952,1954,1955,2386],
        "PRODUCTS2":[1958,1956,2015,1957,2014,1953],
        "PRODUCTS21":[1953],

        "ERROR_NAME":['先生','女士','小姐','大爷','大妈','大娘','大奶','爷爷','奶奶','爸爸','妈妈','叔叔','婶婶','姑姑','姑父','姐夫','姐姐','哥哥','表哥','堂哥'],
        ...
        "ORDER_GOODS_STATUS": {
            ...
            "APPLY_REFUND"  : 200, // 申请退款
            "REFUNDED"      : 201, // 已退款

            "APPLY_RETURN"  : 300, // 申请退货
            "RETURNING"     : 301, // 退货中
            "RETURNED"      : 302, // 已退货
            ...
            //待发货100，已发货101，确认收货102，申请退款200，已退款201，申请退货300，退货中301，已退货302，已完成900，已取消901
        ...
        //商城图片URL
        "SHOP_IMG_URL" : 'http://i.xindongguoji.com/',
