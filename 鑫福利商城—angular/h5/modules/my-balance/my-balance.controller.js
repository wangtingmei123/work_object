(function () {
    ...
    MyBalanceController.$inject = ['$scope', '$http', '$window', '$location', '$state', '$rootScope', 'API', 'BalanceModel','AppAuthenticationService'];

    function MyBalanceController($scope, $http, $window, $location, $state, $rootScope, API, BalanceModel,AppAuthenticationService) {
