...
// const root = "http://local.study.www.xindongguoji.com/index.php/";

// const root_test ="http://xdgj.com/index/";

const root_test = "https://www.xindongguoji.com/";
// const root_test = "http://local.study.www.xindongguoji.com/index.php/";
...
module.exports = {
  ...
  login: root + 'feng/api/weapp/auth',   //登录授权
 ...
 //获取打卡详情信息
  ...
  // 手机号密码登陆页面
  login_user: root+'feng/api/auth/login',        

  // 手机号验证码登陆页面
  get_code: root + 'wechatrun/user/sendCode',       //获取验证码
  login_code: root+ 'feng/api/auth/codelogin',    //登陆
...
// 中信个人成绩
  ...
  //用户信息
  info_show:root_test + 'feng/api/user/show',
...
// 活动专区详情页
  activityInfo: root_test +'feng/api/activity/show',

// 用户统计
activityInfostatic: root_test +'feng/api/statistics/activity',
 ...
 // 答题入口
  ...
  // 运动部落列表页和最多点赞
  sport_list_za: root_test + 'feng/Wechatrun/Sport/list',
  ...
  // 点赞接口
  getPraise: root_test + 'feng/api/praise/post',

  // 评论接口
  getReply: root_test + 'Wechatrun/Sport/getReply',

  // 删除动态
  delArticle: root_test + 'feng/api/article/delete',

  // 上传图片
  uploadImage: root_test +'Wechatrun/Sport/uploadImage',

  // 发布动态
  insertArticle: root_test + 'feng/api/article/post',
  ...
  // 获赞列表
  getPraiseList: root_test + 'feng/api/tops/index/action/activity',

  // 参与率排名
  getCanList: root_test + 'feng/api/tops/statis',

  // 是否可以取消点赞
  ispraise:root_test + 'feng/api/praise/auth',
